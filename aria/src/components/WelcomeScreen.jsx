    ...
    <div className={`ws-root ${phase}`}>
      ...
      <div className="ws-logo-wrap">
        ...
        >
          ...
          {/* ═══ RIPPLE WAVES from star center ═══ */}
          <g transform="translate(252 505)" filter="url(#glow2)">
            <circle r="10" fill="none" strokeWidth="4">
              <animate attributeName="r"            values="10;220"      dur="2.8s" begin="1.2s" repeatCount="indefinite" calcMode="spline" keySplines="0.15 0 0.85 1"/>
              <animate attributeName="opacity"      values="1;0"         dur="2.8s" begin="1.2s" repeatCount="indefinite" calcMode="spline" keySplines="0.15 0 0.85 1"/>
              <animate attributeName="stroke"       values="#c084fc;#38bdf8;#c084fc" dur="2.8s" begin="1.2s" repeatCount="indefinite"/>
            </circle>
            <circle r="10" fill="none" strokeWidth="4">
              <animate attributeName="r"            values="10;220"      dur="2.8s" begin="2.13s" repeatCount="indefinite" calcMode="spline" keySplines="0.15 0 0.85 1"/>
              <animate attributeName="opacity"      values="1;0"         dur="2.8s" begin="2.13s" repeatCount="indefinite" calcMode="spline" keySplines="0.15 0 0.85 1"/>
              <animate attributeName="stroke"       values="#f9a8d4;#fde68a;#f9a8d4" dur="2.8s" begin="2.13s" repeatCount="indefinite"/>
            </circle>
          </g>
