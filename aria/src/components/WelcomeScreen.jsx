    ...
    <div className={`ws-root ${phase}`} ref={containerRef}>
      ...
      <div className="ws-logo-wrap" style={{ transform: `translate(${mousePos.x * 0.5}px, ${mousePos.y * 0.5}px)` }}>
        <div className="ws-svg-container">
          ...
          >
            <defs>
              <linearGradient id="g-star-tl" x1="250" y1="351" x2="75" y2="505" gradientUnits="userSpaceOnUse">
                <stop offset="0%"   stopColor="#f0abfc"><animate attributeName="stop-color" dur="3.2s" repeatCount="indefinite" values="#f0abfc;#fde68a;#7dd3fc;#a5b4fc;#f9a8d4;#f0abfc"/></stop>
                <stop offset="30%"  stopColor="#fde68a"><animate attributeName="stop-color" dur="3.2s" repeatCount="indefinite" values="#fde68a;#7dd3fc;#a5b4fc;#f9a8d4;#f0abfc;#fde68a"/></stop>
                <stop offset="60%"  stopColor="#38bdf8"><animate attributeName="stop-color" dur="3.2s" repeatCount="indefinite" values="#38bdf8;#c084fc;#f0abfc;#fde68a;#7dd3fc;#38bdf8"/></stop>
                <stop offset="100%" stopColor="#818cf8"><animate attributeName="stop-color" dur="3.2s" repeatCount="indefinite" values="#818cf8;#38bdf8;#fde68a;#f0abfc;#c084fc;#818cf8"/></stop>
              </linearGradient>

              <linearGradient id="g-star-tr" x1="253" y1="351" x2="430" y2="505" gradientUnits="userSpaceOnUse">
                <stop offset="0%"   stopColor="#c084fc"><animate attributeName="stop-color" dur="4s" repeatCount="indefinite" values="#c084fc;#7dd3fc;#e0f2fe;#fde68a;#f9a8d4;#c084fc"/></stop>
                <stop offset="35%"  stopColor="#7dd3fc"><animate attributeName="stop-color" dur="4s" repeatCount="indefinite" values="#7dd3fc;#e0f2fe;#fde68a;#f9a8d4;#c084fc;#7dd3fc"/></stop>
                <stop offset="70%"  stopColor="#e0f2fe"><animate attributeName="stop-color" dur="4s" repeatCount="indefinite" values="#e0f2fe;#fde68a;#f9a8d4;#c084fc;#7dd3fc;#e0f2fe"/></stop>
                <stop offset="100%" stopColor="#a5b4fc"><animate attributeName="stop-color" dur="4s" repeatCount="indefinite" values="#a5b4fc;#f9a8d4;#c084fc;#7dd3fc;#e0f2fe;#a5b4fc"/></stop>
              </linearGradient>

              <linearGradient id="g-star-bl" x1="75" y1="511" x2="250" y2="658" gradientUnits="userSpaceOnUse">
                <stop offset="0%"   stopColor="#67e8f9"><animate attributeName="stop-color" dur="3.7s" repeatCount="indefinite" values="#67e8f9;#a78bfa;#f9a8d4;#fde68a;#38bdf8;#67e8f9"/></stop>
                <stop offset="40%"  stopColor="#a78bfa"><animate attributeName="stop-color" dur="3.7s" repeatCount="indefinite" values="#a78bfa;#f9a8d4;#fde68a;#38bdf8;#67e8f9;#a78bfa"/></stop>
                <stop offset="75%"  stopColor="#f9a8d4"><animate attributeName="stop-color" dur="3.7s" repeatCount="indefinite" values="#f9a8d4;#fde68a;#38bdf8;#67e8f9;#a78bfa;#f9a8d4"/></stop>
                <stop offset="100%" stopColor="#fde68a"><animate attributeName="stop-color" dur="3.7s" repeatCount="indefinite" values="#fde68a;#38bdf8;#67e8f9;#a78bfa;#f9a8d4;#fde68a"/></stop>
              </linearGradient>

              <linearGradient id="g-star-br" x1="345" y1="508" x2="429" y2="658" gradientUnits="userSpaceOnUse">
                <stop offset="0%"   stopColor="#fde68a"><animate attributeName="stop-color" dur="4.5s" repeatCount="indefinite" values="#fde68a;#38bdf8;#c084fc;#f9a8d4;#7dd3fc;#fde68a"/></stop>
                <stop offset="33%"  stopColor="#7dd3fc"><animate attributeName="stop-color" dur="4.5s" repeatCount="indefinite" values="#7dd3fc;#c084fc;#f9a8d4;#fde68a;#38bdf8;#7dd3fc"/></stop>
                <stop offset="66%"  stopColor="#c084fc"><animate attributeName="stop-color" dur="4.5s" repeatCount="indefinite" values="#c084fc;#f9a8d4;#fde68a;#38bdf8;#7dd3fc;#c084fc"/></stop>
                <stop offset="100%" stopColor="#f9a8d4"><animate attributeName="stop-color" dur="4.5s" repeatCount="indefinite" values="#f9a8d4;#fde68a;#38bdf8;#7dd3fc;#c084fc;#f9a8d4"/></stop>
              </linearGradient>

              <linearGradient id="g-r-body" x1="396" y1="421" x2="642" y2="533" gradientUnits="userSpaceOnUse">
                <stop offset="0%"   stopColor="#818cf8"><animate attributeName="stop-color" dur="5s" repeatCount="indefinite" values="#818cf8;#38bdf8;#e0f2fe;#fde68a;#f9a8d4;#c084fc;#818cf8"/></stop>
                <stop offset="100%" stopColor="#c084fc"><animate attributeName="stop-color" dur="5s" repeatCount="indefinite" values="#c084fc;#818cf8;#38bdf8;#e0f2fe;#fde68a;#f9a8d4;#c084fc"/></stop>
              </linearGradient>

              <linearGradient id="g-r-leg" x1="487" y1="540" x2="646" y2="629" gradientUnits="userSpaceOnUse">
                <stop offset="0%"   stopColor="#fde68a"><animate attributeName="stop-color" dur="4.2s" repeatCount="indefinite" values="#fde68a;#c084fc;#38bdf8;#e0f2fe;#f9a8d4;#fde68a"/></stop>
                <stop offset="100%" stopColor="#f9a8d4"><animate attributeName="stop-color" dur="4.2s" repeatCount="indefinite" values="#f9a8d4;#fde68a;#c084fc;#38bdf8;#e0f2fe;#f9a8d4"/></stop>
              </linearGradient>

              <linearGradient id="g-i" x1="669" y1="422" x2="706" y2="628" gradientUnits="userSpaceOnUse">
                <stop offset="0%"   stopColor="#a5b4fc"><animate attributeName="stop-color" dur="3.8s" repeatCount="indefinite" values="#a5b4fc;#f9a8d4;#fde68a;#67e8f9;#c084fc;#a5b4fc"/></stop>
                <stop offset="100%" stopColor="#f9a8d4"><animate attributeName="stop-color" dur="3.8s" repeatCount="indefinite" values="#f9a8d4;#c084fc;#a5b4fc;#67e8f9;#fde68a;#f9a8d4"/></stop>
              </linearGradient>

              <linearGradient id="g-a-body" x1="713" y1="419" x2="929" y2="629" gradientUnits="userSpaceOnUse">
                <stop offset="0%"   stopColor="#c084fc"><animate attributeName="stop-color" dur="4.8s" repeatCount="indefinite" values="#c084fc;#38bdf8;#fde68a;#f9a8d4;#818cf8;#c084fc"/></stop>
                <stop offset="100%" stopColor="#818cf8"><animate attributeName="stop-color" dur="4.8s" repeatCount="indefinite" values="#818cf8;#c084fc;#38bdf8;#fde68a;#f9a8d4;#818cf8"/></stop>
              </linearGradient>

              <linearGradient id="g-a-cross" x1="891" y1="547" x2="978" y2="629" gradientUnits="userSpaceOnUse">
                <stop offset="0%"   stopColor="#fde68a"><animate attributeName="stop-color" dur="3.5s" repeatCount="indefinite" values="#fde68a;#818cf8;#38bdf8;#c084fc;#f9a8d4;#fde68a"/></stop>
                <stop offset="100%" stopColor="#38bdf8"><animate attributeName="stop-color" dur="3.5s" repeatCount="indefinite" values="#38bdf8;#c084fc;#f9a8d4;#fde68a;#818cf8;#38bdf8"/></stop>
              </linearGradient>

              <linearGradient id="g-stroke" x1="75" y1="351" x2="978" y2="658" gradientUnits="userSpaceOnUse">
                <stop offset="0%"   stopColor="#f0abfc"><animate attributeName="stop-color" dur="4s" repeatCount="indefinite" values="#f0abfc;#38bdf8;#fde68a;#f9a8d4;#c084fc;#f0abfc"/></stop>
                <stop offset="100%" stopColor="#c084fc"><animate attributeName="stop-color" dur="4s" repeatCount="indefinite" values="#c084fc;#f0abfc;#38bdf8;#fde68a;#f9a8d4;#c084fc"/></stop>
              </linearGradient>
              ...
              <filter id="ws-glow-strong" x="-50%" y="-50%" width="200%" height="200%">
